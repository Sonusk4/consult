              ...
              {links.map((link) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg mb-1 transition-colors ${location.pathname === link.path || (isNotificationLink && location.pathname === '/consultant/dashboard')
